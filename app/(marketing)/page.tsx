      ...
      <header className="sticky top-0 z-50 backdrop-blur-md bg-white/70 border-b border-slate-200/80 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-semibold text-slate-600">
            ...
            <a href="#roles" className="hover:text-emerald-600 transition-colors">How it Works</a>
            <a href="#pricing" className="hover:text-emerald-600 transition-colors">Pricing</a>
            <a href="#faqs" className="hover:text-emerald-600 transition-colors">FAQs</a>
          </nav>

          <div className="hidden md:flex items-center gap-4">
            <a href="https://app.cliniceasy.in/login" className="text-sm font-bold text-slate-600 hover:text-slate-900 transition-colors">
              Sign In
            </a>
            <a
              href="#signup"
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            ...
            >
              <a href="#features" onClick={() => setMobileMenuOpen(false)} className="text-slate-600 hover:text-emerald-600">Features</a>
              <a href="#roles" onClick={() => setMobileMenuOpen(false)} className="text-slate-600 hover:text-emerald-600">How it Works</a>
              <a href="#pricing" onClick={() => setMobileMenuOpen(false)} className="text-slate-600 hover:text-emerald-600">Pricing</a>
              <a href="#faqs" onClick={() => setMobileMenuOpen(false)} className="text-slate-600 hover:text-emerald-600">FAQs</a>
              <hr className="border-slate-200" />
              <div className="flex flex-col gap-3">
                <a href="https://app.cliniceasy.in/login" className="text-center py-2.5 rounded-xl border border-slate-200 text-slate-600 font-bold">Sign In</a>
                <a href="#signup" onClick={() => setMobileMenuOpen(false)} className="text-center py-2.5 rounded-xl bg-slate-900 text-white font-bold">Start Free Trial</a>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
